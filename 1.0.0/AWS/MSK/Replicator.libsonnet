{
  new(
    ...
    Properties: {
      ...
      ReplicationInfoList: (if std.isArray(ReplicationInfoList) then ReplicationInfoList else [ReplicationInfoList]),
      KafkaClusters: (if std.isArray(KafkaClusters) then KafkaClusters else [KafkaClusters]),
