  ...
  new(
    ...
    Properties: {
      Format:
        ...
        else if std.length(Format) < 1 then error ('Format should have at least 1 characters')
        else if std.length(Format) > 300 then error ('Format should have not more than 300 characters')
        else Format,
      Location:
  ...
  setDetectorId(DetectorId): {
    Properties+::: {
      DetectorId:
        ...
        else if std.length(DetectorId) > 32 then error ('DetectorId should have not more than 32 characters')
        else DetectorId,
    },
  },
  setName(Name): {
