{
  new(
    ...
    Properties: {
      ...
      TransportAttachmentId:
        if !std.isString(TransportAttachmentId) then (error 'TransportAttachmentId must be a string')
        else if std.isEmpty(TransportAttachmentId) then (error 'TransportAttachmentId must be not empty')
        else TransportAttachmentId,
      Options:
