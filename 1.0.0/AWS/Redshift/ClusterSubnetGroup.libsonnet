  ...
  new(
    ...
    Properties: {
      ...
      SubnetIds:
        ...
        else if std.length(SubnetIds) > 20 then error ('SubnetIds cannot have more than 20 items')
        else SubnetIds,
    },
    DependsOn:: [],
    CreationPolicy:: [],
  ...
  setClusterSubnetGroupName(ClusterSubnetGroupName): {
    Properties+::: {
      ClusterSubnetGroupName:
        ...
        else if std.length(ClusterSubnetGroupName) > 255 then error ('ClusterSubnetGroupName should have not more than 255 characters')
