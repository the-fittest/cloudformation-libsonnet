{
  ...
  withState(State): {
    ...
    assert State == 'ACTIVE' || State == 'CREATING' || State == 'UPDATING' || State == 'DELETING' || State == 'CREATE_FAILED' || State == 'UPDATE_FAILED' : "State should be 'ACTIVE' or 'CREATING' or 'UPDATING' or 'DELETING' or 'CREATE_FAILED' or 'UPDATE_FAILED'",
    Properties+::: {
      State: State,
    },
  },
