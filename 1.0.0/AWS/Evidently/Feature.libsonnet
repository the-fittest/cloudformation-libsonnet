{
  new(
    ...
    Properties: {
      ...
      Project: Project,
      Variations: (if std.isArray(Variations) then Variations else [Variations]),
    },
    DependsOn:: [],
    CreationPolicy:: [],
    DeletionPolicy:: [],
  ...
  withEntityOverrides(EntityOverrides): {
    Properties+::: {
      EntityOverrides: (if std.isArray(EntityOverrides) then EntityOverrides else [EntityOverrides]),
    },
  },
