  ...
  setPattern(Pattern): {
    Properties+::: {
      Pattern:
        ...
        else if std.length(Pattern) < 1 then error ('Pattern should have at least 1 characters')
        else if std.length(Pattern) > 1024 then error ('Pattern should have not more than 1024 characters')
        else Pattern,
    },
  },
  setTags(Tags): {
