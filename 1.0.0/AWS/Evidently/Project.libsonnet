{
  ...
  setDataDelivery(DataDelivery): {
    Properties+::: {
      DataDelivery:
        if !std.isObject(DataDelivery) then (error 'DataDelivery must be an object')
        else DataDelivery,
    },
  },
  setAppConfigResource(AppConfigResource): {
    Properties+::: {
      AppConfigResource:
        if !std.isObject(AppConfigResource) then (error 'AppConfigResource must be an object')
        else if !std.objectHas(AppConfigResource, 'ApplicationId') then (error ' have attribute ApplicationId')
        else if !std.objectHas(AppConfigResource, 'EnvironmentId') then (error ' have attribute EnvironmentId')
        else AppConfigResource,
    },
  },
  setTags(Tags): {
    Properties+::: {
