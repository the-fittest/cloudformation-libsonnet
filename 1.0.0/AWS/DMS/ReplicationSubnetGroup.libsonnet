{
  new(
    ...
    Properties: {
      ReplicationSubnetGroupDescription:
        if !std.isString(ReplicationSubnetGroupDescription) then (error 'ReplicationSubnetGroupDescription must be a string')
        else if std.isEmpty(ReplicationSubnetGroupDescription) then (error 'ReplicationSubnetGroupDescription must be not empty')
        else ReplicationSubnetGroupDescription,
      SubnetIds:
