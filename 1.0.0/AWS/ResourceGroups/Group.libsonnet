{
  ...
  setResourceQuery(ResourceQuery): {
    Properties+::: {
      ResourceQuery:
        if !std.isObject(ResourceQuery) then (error 'ResourceQuery must be an object')
        else ResourceQuery,
    },
  },
  setTags(Tags): {
  ...
  setConfiguration(Configuration): {
    Properties+::: {
      Configuration:
        if !std.isArray(Configuration) then (error 'Configuration must be an array')
        else Configuration,
    },
  },
  setConfigurationMixin(Configuration): {
    Properties+::: {
