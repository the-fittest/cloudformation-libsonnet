{
  ...
  AccessPolicy: {
    new(
      ...
      local base = self,
      Properties: {
        assert std.isObject(AccessPolicyIdentity) : 'AccessPolicyIdentity must be an object',
        ...
        assert std.isObject(AccessPolicyResource) : 'AccessPolicyResource must be an object',
