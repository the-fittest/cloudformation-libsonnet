{
  new(
    ...
    Properties: {
      ConfigurationPolicy:
        if !std.isObject(ConfigurationPolicy) then (error 'ConfigurationPolicy must be an object')
        else ConfigurationPolicy,
      Name:
  ...
  setServiceEnabled(ServiceEnabled): {
    Properties+::: {
      ServiceEnabled:
        if !std.isBoolean(ServiceEnabled) then (error 'ServiceEnabled must be a boolean') else ServiceEnabled,
    },
  },
  setTags(Tags): {
    Properties+::: {
