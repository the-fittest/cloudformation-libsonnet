{
  new(
    ...
    local base = self,
    Properties: {
      AllowedCountries: (if std.isArray(AllowedCountries) then AllowedCountries else [AllowedCountries]),
      AllowedOrigins: (if std.isArray(AllowedOrigins) then AllowedOrigins else [AllowedOrigins]),
    },
    DependsOn:: [],
    CreationPolicy:: [],
    DeletionPolicy:: [],
