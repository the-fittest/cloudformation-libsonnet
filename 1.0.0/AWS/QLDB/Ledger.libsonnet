{
  new(
    ...
    Properties: {
      PermissionsMode:
        if !std.isString(PermissionsMode) then (error 'PermissionsMode must be a string')
        else if std.isEmpty(PermissionsMode) then (error 'PermissionsMode must be not empty')
        else PermissionsMode,
    },
    DependsOn:: [],
    CreationPolicy:: [],
    DeletionPolicy:: [],
