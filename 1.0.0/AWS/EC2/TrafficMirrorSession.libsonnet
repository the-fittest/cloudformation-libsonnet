  ...
  TrafficMirrorSession: {
    new(
      ...
      Properties: {
        ...
        assert std.isNumber(SessionNumber) : 'SessionNumber must be a number',
    ...
    withVirtualNetworkId(VirtualNetworkId): {
      assert std.isNumber(VirtualNetworkId) : 'VirtualNetworkId must be a number',
      Properties+::: {
        VirtualNetworkId: VirtualNetworkId,
      },
    },
    withPacketLength(PacketLength): {
      assert std.isNumber(PacketLength) : 'PacketLength must be a number',
      Properties+::: {
