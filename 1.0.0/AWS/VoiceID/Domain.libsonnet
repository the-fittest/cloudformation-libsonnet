  ...
  new(
    ...
    Properties: {
      ...
      ServerSideEncryptionConfiguration:
        ...
        else if !std.objectHas(ServerSideEncryptionConfiguration, 'KmsKeyId') then (error ' have attribute KmsKeyId')
  ...
  setDomainId(DomainId): {
    Properties+::: {
      DomainId:
        ...
        else if std.length(DomainId) < 22 then error ('DomainId should have at least 22 characters')
        else if std.length(DomainId) > 22 then error ('DomainId should have not more than 22 characters')
        else DomainId,
    },
  },
  setTags(Tags): {
