{
  ...
  setGatewayRouteName(GatewayRouteName): {
    Properties+::: {
      GatewayRouteName:
        if !std.isString(GatewayRouteName) then (error 'GatewayRouteName must be a string')
        else if std.isEmpty(GatewayRouteName) then (error 'GatewayRouteName must be not empty')
        else GatewayRouteName,
    },
  },
  setId(Id): {
    Properties+::: {
