{
  ...
  setVirtualNodeName(VirtualNodeName): {
    Properties+::: {
      VirtualNodeName:
        if !std.isString(VirtualNodeName) then (error 'VirtualNodeName must be a string')
        else if std.isEmpty(VirtualNodeName) then (error 'VirtualNodeName must be not empty')
        else VirtualNodeName,
    },
  },
  setTags(Tags): {
    Properties+::: {
