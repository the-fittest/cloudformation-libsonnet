{
  new(
    ...
    Properties: {
      ...
      VirtualServiceName:
        if !std.isString(VirtualServiceName) then (error 'VirtualServiceName must be a string')
        else if std.isEmpty(VirtualServiceName) then (error 'VirtualServiceName must be not empty')
        else VirtualServiceName,
      Spec:
